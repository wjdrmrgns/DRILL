...
p2 = x2, y2 = random.randint(-300, -100), random.randint(100, 500)
p3 = x3, y3 = random.randint(-300, -100), random.randint(-300, -200)
p4 = x4, y4 = random.randint(200, 400), random.randint(-500, -300)

#blend_lines(p2,p3,  p4,p1)

# draw_line(p1,p2)
#draw_curve_3_points(p2,p1,p4)

draw_curve_4_points(p3, p2, p4, p1)
